...
from vectorstore.chroma import get_embeddings, get_vector_store, persist_documents
...
def rag_tool(query: str) -> dict:
    ...
    try:
        ...
        return {"query": query, "context": [], "metadata": [], "error": f"Failed to retrieve context: {str(e)}"}
